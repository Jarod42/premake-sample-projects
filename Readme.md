...
|[`compileas`](https://premake.github.io/docs/compileas) |:grey_question:|:grey_question:|:grey_question:|:grey_question:|:grey_question:|:grey_question:|:grey_question:|:grey_question:|:grey_question:|
...
|basic|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:grey_question:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|
|moc|:heavy_check_mark:|:x:[^gmake2_qt_issue]|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:grey_question:|:x:[^codeblocks_custom_build]|:heavy_check_mark:|:heavy_check_mark:|
|qrc|:heavy_check_mark:|:x:[^gmake2_qt_issue]|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:grey_question:|:x:[^codeblocks_custom_build]|:heavy_check_mark:|:heavy_check_mark:|
|uic|:heavy_check_mark:|:x:[^gmake2_qt_issue]|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:grey_question:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|
